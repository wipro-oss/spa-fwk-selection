  ...
  return [
    {
      ...
      "children": [
        {
          "name": "Interent vs. Intranet (Uncontrolled vs. Controlled | Trusted vs Untrusted)",
        ...
        {
          "name": "Channel Coverage (Desktop, Smartphone, Tablets)",
        ...
        {
          "name": "Connectivity (Speed of network connectivity)",
    ...
    },
    {
      ...
      "children": [
        {
          "name": "Standard UI elements vs. Custom UI elements",
        ...
        {
          "name": "Same UI metaphor across channels vs. Mobile First",
    ...
    },
    {
      ...
      "children": [
        {
          "name": "Green field vs. Brown field",
        ...
        {
          "name": "Service Interfaces (XML vs JSON, HTTP methods)",
        ...
        {
          "name": "Isomorphic capability (Capability exists to execute code on server when needed, reuse models/validations)",
    ...
    },
    {
      ...
      "children": [
        {
          "name": "Size of possible codebase",
        ...
        {
          "name": "Complexity of data entities invovled (model richness and attribute types)",
        ...
        {
          "name": "Modularity (functional modules, lazy load modules)",
