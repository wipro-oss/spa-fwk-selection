      ...
      "children": [
        {
          ...
          "questions": [
            {
              "question": "Do you need Internet Explorer support?",
              "values": [
                { "label": "Yes", "value": 0 },
                { "label": "No", "value": 1}
              ]
            ...
            {
              "question": "Can you target only modern browsers?",
              "values": [
                { "label": "Yes", "value": 1 },
                { "label": "No", "value": 0}
              ]
        ...
        },
        {
          ...
          "questions": [
            {
              "question": "Do need mobile support?",
              "values": [
                { "label": "Yes", "value": 0 },
                { "label": "No", "value": 1}
              ]
        ...
        },
        {
          ...
          "questions": [
            {
              "question": "Will the application operate in low bandwidth situations?",
              "values": [
                { "label": "Yes", "value": 0 },
                { "label": "No", "value": 1}
              ]
      ...
      "children": [
        {
          ...
          "questions": [
            {
              "question": "What is the expected level of user interactions?",
              "values": [
                { "label": "Low", "value": .2 },
        ...
        },
        {
          ...
          "questions": [
            {
              "question": "What is the applications realtime requirements?",
              "values": [
                { "label": "None", "value": 0 },
                { "label": "Some", "value": .5 },
                { "label": "Fully", "value": 1 }
        ...
        },
        {
          ...
          "questions": [
            {
              "question": "Will the application display large number of UI elements?",
              "values": [
                { "label": "Low", "value": .2 },
                { "label": "Medium", "value": .7 },
                { "label": "High", "value": 1 }
        ...
        },
        {
          ...
          "questions": [
            {
              "question": "What is the validation requirement?",
              "values": [
                { "label": "Low", "value": .2 },
                { "label": "Medium", "value": .7 },
                { "label": "High", "value": 1 }
        ...
        },
        {
          ...
          "questions": [
            {
              "question": "What UI metaphor do you prefer?",
              "values": [
      ...
      "children": [
        {
          ...
          "questions": [
            {
              "question": "What is the objective of building the application",
              "values": [
                { "label": "Build new experiences", "value": 1 },
                { "label": "Replace existing applications", "value": .5},
                { "label": "New application development", "value": 0}
              ]
            }
          ]
        },
        {
          ...
          "questions": [
            {
              "question": "What kind of backend services do plan to develop?",
              "values": [
                { "label": "REST resources only", "value": 0 },
                { "label": "JSON only", "value": .1 },
                { "label": "JSON/XML", "value": .2 },
                { "label": "Any", "value": .3 }
              ]
            }
          ]
        },
        {
          ...
          "questions": [
            {
              "question": "Do need the framework to be isomorphic?",
              "values": [
                { "label": "Yes", "value": 0 },
                { "label": "No", "value": 1}
              ]
